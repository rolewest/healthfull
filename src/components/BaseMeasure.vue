...
needed for sets to failure for a specific repetition number[1].`,
        ...
        <div class="alert alert-primary">
          ...
          <fieldset>
            <legend>
              <q-icon class="text-h3" name="medication"></q-icon>Prescription
            </legend>
            <span class="text-h5">Recommended Weekly Meal Plan</span>
            <div class="border-double-1 graphPaper-2">
              <span v-html="computeDifficultyFromDoctorMouthFood"></span>
            </div>
            Recommended Weekly <i>{{ user }}</i> Exercises
            <div class="border-double-1 graphPaper-2">In Progress</div>
            ...
            <div style="width: 99%; border-bottom: 1px solid">
              <span class="text-h5">℞</span>:<span class="cursive-text"
                >Dr. Doctor</span
              >
            </div>
          </fieldset>
...
export default {
  ...
  computed: {
    ...
    computeDifficultyFromDoctorMouthFood() {
      ...
      if (this.userLevel <= 1)
        ...
        <div class="q-ma-sm"><div class="bg-primary">•Before every meal enjoy:</div>
          ...
          <details class="q-ml-md noblink-details"><summary>A delicious simple salad</summary>Vinegar Boosts AMPK which boosts your metabolism, and a healthy salad reduces your hunger:
    ...
    computeDifficultyFromDoctorMouthExercise() {
      if (this.userLevel <= 1) return `Lets do the thing`;
